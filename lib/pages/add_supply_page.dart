...
class AddSupplyPage extends StatefulWidget {
  ...
  const AddSupplyPage({Key? key, required this.userId}) : super(key: key);

  @override
  State<AddSupplyPage> createState() => _AddSupplyPageState();
}

class _AddSupplyPageState extends State<AddSupplyPage> with TickerProviderStateMixin {
  ...
  SupplyStatus _selectedStatus = SupplyStatus.available;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Yüklenen dosya: $_uploadedFileName',
          ...
          CustomButton(
            text: _isUploadingFile ? 'Yükleniyor...' : 'Dosya Seç',
  ...
  Future<void> _addSupply() async {
    ...
    try {
      ...
      await _databaseService.createSupply(supply);

      SnackBarUtils.showSuccess(
        context: context,
        message: 'Tedarik başarıyla eklendi',
      );
      ...
      SnackBarUtils.showError(
        context: context,
        message: 'Tedarik eklenirken hata oluştu: $e',
      );
    } finally {
